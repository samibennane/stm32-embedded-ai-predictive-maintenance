/**
  ...
  ******************************************************************************
  */
#ifndef AI_MACHINE_FAILURES_H
#define AI_MACHINE_FAILURES_H

#include "machine_failures_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MACHINE_FAILURES_MODEL_NAME          "machine_failures"
#define AI_MACHINE_FAILURES_ORIGIN_MODEL_NAME   "machine_failure_model"

/******************************************************************************/
#define AI_MACHINE_FAILURES_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MACHINE_FAILURES_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MACHINE_FAILURES_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MACHINE_FAILURES_IN_NUM        (1)

AI_DEPRECATED
#define AI_MACHINE_FAILURES_IN \
  ai_machine_failures_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MACHINE_FAILURES_IN_SIZE { \
  AI_MACHINE_FAILURES_IN_1_SIZE, \
}
#define AI_MACHINE_FAILURES_IN_SIZE_BYTES { \
  AI_MACHINE_FAILURES_IN_1_SIZE_BYTES, \
}
#define AI_MACHINE_FAILURES_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MACHINE_FAILURES_IN_1_CHANNEL     (8)
#define AI_MACHINE_FAILURES_IN_1_SIZE        (8)
#define AI_MACHINE_FAILURES_IN_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_MACHINE_FAILURES_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MACHINE_FAILURES_OUT \
  ai_machine_failures_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MACHINE_FAILURES_OUT_SIZE { \
  AI_MACHINE_FAILURES_OUT_1_SIZE, \
}
#define AI_MACHINE_FAILURES_OUT_SIZE_BYTES { \
  AI_MACHINE_FAILURES_OUT_1_SIZE_BYTES, \
}
#define AI_MACHINE_FAILURES_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MACHINE_FAILURES_OUT_1_CHANNEL     (5)
#define AI_MACHINE_FAILURES_OUT_1_SIZE        (5)
#define AI_MACHINE_FAILURES_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MACHINE_FAILURES_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup machine_failures
 ...
 * @ref ai_machine_failures_create. Both the activations memory buffer 
 ...
 * using @ref ai_machine_failures_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_machine_failures_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_machine_failures_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MACHINE_FAILURES_*
 * defines into file @ref machine_failures.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_machine_failures_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MACHINE_FAILURES_H */
